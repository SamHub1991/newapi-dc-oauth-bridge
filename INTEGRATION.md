...
```text
/
├── INTEGRATION.md          ← This file: system overview and deployment guide
├── README.md               ← New API upstream documentation
...
- New API documentation: [README.md](./README.md) | [Official Docs](https://docs.newapi.pro/en/docs)
